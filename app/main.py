...
from app.api.routes import (auth, assets, customers, bookings, availability,
                            ...
                            addons, public_booking, tours, push, blocks, waivers, platform, staff, integration, api_keys, partners)
...
for r in (auth, assets, customers, bookings, availability, messages,
          emails, reports, webhooks, dashboard, packages, transfers, calendar, mailboxes, payments, settings_routes, addons, public_booking, tours, push, blocks, waivers, platform, staff, integration, api_keys, partners):
    app.include_router(r.router)
app.include_router(public_booking.widget_router)
app.include_router(waivers.public_router)
